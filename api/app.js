...
// const stripeRouter = require('./payment/stripeRouter'); //we can add this back in when stripe router is created
...
// app.use(['/payment', '/payments'], stripeRouter);// we can add this back in when stripe router is created
